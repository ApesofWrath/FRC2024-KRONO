...
namespace drivetrainConstants {
    ...
    namespace calculations {
        ...
        constexpr auto kModuleToCenterDist{9.875_in};
        constexpr auto kChassisRadius{13.96536_in};
        constexpr auto kModuleMaxSpeed{15.1_fps * 0.8};
        constexpr auto kChassisMaxSpeed{15.1_fps * 0.8};

        constexpr units::radians_per_second_t kModuleMaxAngularVelocity{(kModuleMaxSpeed.value() * 12.0) / kChassisRadius.value()};  // radians per second
