...
namespace intakeConstants {
    ...
    constexpr double kIntakeResetAngle = 0;
    constexpr double kIntakeSpeakerAngle = 144.5; // 
    constexpr double kIntakeAmpAngle = 26;
    constexpr double kIntakeIntakingAngle = 126;
}
